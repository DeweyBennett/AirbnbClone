...
import {HiGlobeAlt, HiMenu, HiSearch, HiUser, HiUserCircle} from "react-icons/hi"
        ...
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            ...
            <div className='flex items-center md:border-2 rounded-full p-2'>
                <input
                    ...
                    type='text'
                    className='pl-5 bg-transparent outline-none flex-grow md:first-letter:shadow-sm text-sm text-gray-600 placeholder-gray-400'
